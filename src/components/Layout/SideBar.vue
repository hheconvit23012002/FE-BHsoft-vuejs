                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <ul class="metismenu side-nav mm-show">
                                    ...
                                    <li class="side-nav-item">
                                        <router-link :to="{name : 'admin-users'}" class="side-nav-link">
                                            <i class="uil-home-alt"></i>
                                            <span> User </span>
                                        </router-link>
                                    </li>
                                    <li class="side-nav-item">
                                        <router-link :to="{name : 'admin-courses'}" class="side-nav-link">
                                            <i class="uil-home-alt"></i>
                                            <span> Courses </span>
                                        </router-link>
                                    </li>
                                    <li class="side-nav-item">
                                        <router-link :to="{name : 'admin-dashboard'}" class="side-nav-link">
                                            <i class="uil-home-alt"></i>
                                            <span> Dashboard </span>
                                        </router-link>
                                    </li>
